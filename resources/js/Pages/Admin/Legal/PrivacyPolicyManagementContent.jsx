...
const PrivacyPolicyManagementContent = ({ privacyPolicy, version }) => {
                ...
                <div className="bg-white shadow-xl rounded-2xl overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-pink-500 to-rose-500 p-6 md:p-8">
                        ...
                        <p className="text-center text-white/80 mt-2 max-w-2xl mx-auto">
                            Kelola kebijakan privasi untuk aplikasi Anda
                        </p>
                    </div>
                    ...
                    <div className="p-6 md:p-8">
                        <form onSubmit={handleSubmit}>
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-xl font-semibold text-gray-800">Kebijakan Privasi</h2>
                            ...
                            <div className="flex items-center justify-end gap-3">
                                <button
                                    type="button"
                                    onClick={() => editor && editor.commands.setContent(privacyPolicy)}
...
export default PrivacyPolicyManagementContent;
