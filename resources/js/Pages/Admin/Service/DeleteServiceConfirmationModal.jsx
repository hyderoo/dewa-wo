...
const DeleteServiceConfirmationModal = ({ isOpen, onClose, service }) => {
    const [isDeleting, setIsDeleting] = useState(false);
    const [error, setError] = useState("");

    const handleConfirmDelete = () => {
        if (isDeleting || !service) return;
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-xl max-w-md w-full text-gray-600">
                ...
                <p className="text-gray-600 mb-6 text-center">
                    Apakah Anda yakin ingin menghapus layanan <span className="font-semibold">{service?.title}</span>? Tindakan ini tidak dapat dibatalkan.
                </p>
