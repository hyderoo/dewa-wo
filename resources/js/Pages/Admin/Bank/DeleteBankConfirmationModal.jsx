...
const DeleteBankConfirmationModal = ({ isOpen, onClose, bank }) => {
    const [isDeleting, setIsDeleting] = useState(false);
    const [error, setError] = useState("");

    const handleConfirmDelete = () => {
        if (isDeleting || !bank) return;
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-xl max-w-md w-full text-gray-600">
                ...
                <p className="text-gray-600 mb-6 text-center">
                    Are you sure you want to delete the bank account <span className="font-semibold">{bank?.name}</span>? This action cannot be undone.
                </p>
...
export default DeleteBankConfirmationModal;
